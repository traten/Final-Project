...
void printQuiz(){
    ...
    std::cout << "A) Lion" << endl;
    std::cout << "B) Mouse" << endl;
    std::cout << "C) Unicorn" << endl;
    std::cout << "D) Owl \n" << endl;
    ...
    std::cout << "D) Burin it because the government is oppressive and this is the best way to get back at them. HA! \n" <<endl;
